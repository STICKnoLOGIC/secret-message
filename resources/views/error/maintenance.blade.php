...
@section('content')
    <div class="relative flex items-center justify-center md:justify-end h-40 md:h-96 w-full overflow-hidden my-6">
    ...
    <p class="w-full mt-[32px] text-center wrap-break-word mb-6"> " Site is Down: We're cooking something!!! " </p>
