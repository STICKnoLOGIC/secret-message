...
@section('content')
    <div class="relative flex items-center justify-center md:justify-end h-40 md:h-96 w-full overflow-hidden">
        <!-- Background text -->
    ...
    <p class="w-full text-center wrap-break-word"> "{{ $message ?? 'Something went wrong.' }}"</p>
