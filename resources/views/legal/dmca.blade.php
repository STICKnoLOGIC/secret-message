...
@section('title','DMCA Policy — STICKnoLOGIC')

@section('content')
        <h1 class="text-3xl font-bold mb-4 text-orange-600 dark:text-orange-400">DMCA / Copyright Policy</h1>

        <p class="mb-4 text-neutral-900 dark:text-neutral-300">
            <strong>STICKnoLOGIC</strong> (<a href="https://secret.sticknologic.is-a.dev" class="text-orange-600 dark:text-orange-400 hover:underline">secret.sticknologic.is-a.dev</a>)
        ...
        <h2 class="text-xl font-semibold text-orange-600 dark:text-orange-400 mt-6 mb-2">Important Notes</h2>
        ...
        <h2 class="text-xl font-semibold text-orange-600 dark:text-orange-400 mt-6 mb-2">DMCA Contact</h2>
        ...
        <div class="bg-gray-50 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-300 border rounded-md p-4 mb-4">
            ...
            <p><strong>Address:</strong> Purok #2, Pawa, Legazpi, Albay 4500, Philippines</p>
            <p><strong>Phone:</strong> <em>Not provided</em></p>
        </div>

        <h2 class="text-xl font-semibold text-orange-600 dark:text-orange-400 mt-6 mb-2">How to File</h2>
        ...
        <h2 class="text-xl font-semibold text-orange-600 dark:text-orange-400 mt-8 mb-2">How we respond</h2>
        <ul class="list-disc text-neutral-900 dark:text-neutral-300 ml-6 space-y-1">
            ...
            <li>We notify the user who submitted the content so they may file a counter-notice.</li>
            <li>We preserve relevant logs and records.</li>
            <li>If we receive a valid counter-notice, we follow DMCA procedures and may restore content after the statutory waiting period, unless instructed otherwise by a court.</li>
        </ul>

        <h2 class="text-xl font-semibold text-orange-600 dark:text-orange-400 mt-6 mb-2">Jurisdiction</h2>
        ...
        <footer class="mt-10 border-t pt-4 text-xs text-gray-500 dark:text-gray-300">
            ...
            <p class="mt-2 text-amber-600">© STICKnoLOGIC</p>
        </footer>
@endsection
